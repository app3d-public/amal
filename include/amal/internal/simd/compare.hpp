...
namespace amal::internal
{
    ...
    inline __v4si_u less_than_mask(__v4si_u x, __v4si_u y)
    {
        ...
        __m128i yi = AMAL_M128I(y);
        __m128i cmp = _mm_cmplt_epi32(xi, yi);
        return AMAL_V4SI(cmp);
    }
    ...
    {
        __m128i cmp = _mm_cmplt_epi32(AMAL_M128I(x), AMAL_M128I(y));
        __m128i inv_cmp = _mm_andnot_si128(cmp, _mm_set1_epi32(-1));
        return AMAL_V4SI(inv_cmp);
    }
    ...
    {
        __m128i cmp = _mm_cmpeq_epi32(AMAL_M128I(x), AMAL_M128I(y));
        return AMAL_V4SI(cmp);
    }
    #else
